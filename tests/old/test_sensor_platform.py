"""Testet das Setup der Sensor-Plattform für die Solar Window System Integration."""
...
async def test_sensor_platform_setup(hass: HomeAssistant) -> None:
    """Testet, ob Sensor-Entities korrekt registriert werden."""
    ...
    msg_no_entities = "Es wurden keine Sensor-Entities registriert."
