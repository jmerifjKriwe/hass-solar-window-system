"""Testet das Setup der Switch-Plattform für die Solar Window System Integration."""
...
async def test_switch_platform_setup(hass: HomeAssistant) -> None:
    """Testet, ob Switch-Entities korrekt registriert werden."""
    ...
    msg_no_entities = "Es wurden keine Switch-Entities registriert."
