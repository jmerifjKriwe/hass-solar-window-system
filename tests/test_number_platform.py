"""Testet das Setup der Number-Plattform für die Solar Window System Integration."""
...
async def test_number_platform_setup(hass: HomeAssistant) -> None:
    """Testet, ob Number-Entities korrekt registriert werden."""
    ...
    msg_no_entities = "Es wurden keine Number-Entities registriert."
