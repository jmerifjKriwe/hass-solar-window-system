"""Testet das Setup der Text-Plattform für die Solar Window System Integration."""
...
async def test_text_platform_setup(hass: HomeAssistant) -> None:
    """Testet, ob Text-Entities korrekt registriert werden."""
    ...
    msg_no_entities = "Es wurden keine Text-Entities registriert."
